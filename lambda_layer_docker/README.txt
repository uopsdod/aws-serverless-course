...
# 建立 Docker Image 
docker build -t layer-function --no-cache .
docker images

# 啟動 Docker 容器
docker run -d --name layer-function -p 9000:8080 layer-function:latest
docker container ls 
...
# 關閉 Docker 容器
docker stop layer-function
docker rm layer-function
...
# 上傳本地 Docker Image
docker images
docker tag layer-function:latest "${ECR_REPO_URL}:latest"
docker images
docker push "${ECR_REPO_URL}:latest"

# 建立 Lambda function 
AWS_ACCOUNT=659104334423
LAMBDA_FUNCTION_NAME="docker-layer-function"
